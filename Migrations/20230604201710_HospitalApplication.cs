...
{
    public partial class HospitalApplication : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Patients_Wallets_WalletId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pharmacists_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Complaints_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prescriptions_Complaints_ComplaintsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Patients_WalletId1",
                table: "Patients",
                column: "WalletId1");

            migrationBuilder.CreateIndex(
                name: "IX_Pharmacists_RoleId",
                table: "Pharmacists",
                column: "RoleId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_ComplaintsId",
                table: "Prescriptions",
                column: "ComplaintsId");
